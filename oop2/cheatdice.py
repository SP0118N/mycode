...
class Cheat_Sabotagy(Player):
    def cheat(self, other_player):
        other_player_dice= other_player.get_dice()
        if len(other_player_dice) =3:
            other_player_dice[2]= random.ranint(1,3)
